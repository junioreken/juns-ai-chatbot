// JUN'S AI Chatbot - Shopify Integration Script
// Add this script to your Shopify store theme (in theme.liquid or as a separate asset)
...
(function() {
  ...
  const CHATBOT_CONFIG = {
    apiUrl: 'https://juns-ai-chatbot-production.up.railway.app/chat',
    position: 'bottom-right', // bottom-right, bottom-left, top-right, top-left
    delay: 3000, // Delay before showing chatbot (in milliseconds)
    theme: {
      primaryColor: '#000000',
